...
function Courses({ cardImage,cardCourseName,cardCourseData}) {
  return (
   <>
      <div className=' relative shadow-lg shadow-white-500/50 lg:h-[84vh] lg:w-[24vw] h-[82vh] w-[84vw] md:h-[80vh] md:w-[50vw] sm:h-[80vh] sm:w-[60vw] rounded-xl my-4 mx-2 dark:bg-[#1E293B] '>
           ...
           <button className='bg-[#9333EA]  py-2 px-3 text-white rounded-xl font-semibold  absolute bottom-4 mx-4  '>Start Watching</button>
       </div>
   </>
  )
}
